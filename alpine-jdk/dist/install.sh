...
curl -OLH "Cookie: oraclelicense=accept-securebackup-cookie" http://download.oracle.com/otn-pub/java/jdk/$ver-$build/e9e7ea248e2c4826b92b3f075a80e441/jdk-$ver-linux-x64.tar.gz
